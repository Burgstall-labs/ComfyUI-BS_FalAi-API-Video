    ...
    def INPUT_TYPES(cls):
        inputs = {
            ...
            "optional": {
                ...
                "override_start_image_param": ("STRING", {"multiline": False, "default": ""}),
                "override_end_image_param": ("STRING", {"multiline": False, "default": ""}),
                "override_video_param": ("STRING", {"multiline": False, "default": ""}),
                "override_audio_param": ("STRING", {"multiline": False, "default": ""}),
            }
        }
        for i in range(1, 11):
